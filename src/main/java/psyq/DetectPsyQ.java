...
public class DetectPsyQ {
	private final static byte[] VERSION_BYTES = new byte[] {      0x50,       0x73,       0x00, 0x00, 0x00, 0x00,       0x00,       0x00}; // byte 3 is a lib number, byte 7 is the version
	private final static byte[] VERSION_MASK = new byte[]  {(byte)0xFF, (byte)0xFF, (byte)0xE0, 0x00, 0x00, 0x00, (byte)0x88, (byte)0xEE};
